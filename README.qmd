---
title: "Reproducibility Report: Coppock (2020)"
...
format:
  gfm:
    ...
    toc: true
  pdf:
    output-file: coppock_2020_report.pdf
    toc: true
    toc-depth: 2
...
gt <- read_csv(here::here("ground_truth", "coppock_2020_ground_truth.csv"),
...
This repository holds the actively maintained replication code for Coppock (2020), together with the reproducibility report that documents what the original archive did and did not do. It is part of a program applying the maintenance proposal in Peer, Orr and Coppock (2021, *PS: Political Science & Politics*, doi [10.1017/S1049096521000366](https://doi.org/10.1017/S1049096521000366)) to a set of published archives.
...
**To reproduce.** Clone or download the repository, open `coppock_2020.Rproj`, and run:
...
**Citation**: Coppock, A. (2020). "Visualize as you randomize: Design-based statistical graphs for randomized experiments." In J. N. Druckman and D. P. Green (eds.), *Advances in Experimental Political Science*, 320-336. Cambridge University Press. DOI: 10.1017/9781108777919.022. Crossref dates the volume to April 2021; this program indexes the chapter as 2020, following the author's own catalogue.
